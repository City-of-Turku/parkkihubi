...
param apiUrl = 'https://testiparkki.turku.fi'
...
param apiReplicaUrl = 'https://testiparkkiopas.turku.fi'
...
@secure()
param socialAuthTunnistamoKey = ''
@secure()
param socialAuthTunnistamoSecret = ''
param socialAuthTunnistamoOidcEndpoint = ''
param oidcApiAudience = '' // Comma-separated list of audiences
param oidcApiScopePrefix = ''
param oidcApiIssuer = ''
param oidcApiAuthorizationField = ''
param oidcApiRequireScopeForAuthentication = true
